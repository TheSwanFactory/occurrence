...
3. G. Moreno, *The zero divisors of the Cayley–Dickson algebras over the real numbers*, Bol. Soc. Mat. Mexicana (3) 4 (1998) 13–28; arXiv:q-alg/9710013. ● (the algebraic underpinning for Definition 3.4: special triples, Cor. 2.12, Thm. 2.13, four-dimensional annihilators; the pair-space topology is deferred to the sequel below.) G. Moreno, *Constructing zero divisors in the higher dimensional Cayley-Dickson algebras*, arXiv:math/0512517 (2005). ● (fixed-norm single zero-divisor locus ≅ V₇,₂; normalized annihilating-pair set ≅ G₂; fibration with fibre S³ — the topological attribution for Definition 3.4)
